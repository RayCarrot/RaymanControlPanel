...
public sealed class GameDescriptor_Rayman3_Demo_20030108_Win32 : Win32GameDescriptor
{
    ...
    public override string LegacyGameId => "Demo_Rayman3_5";
    public override Game Game => Game.Rayman3;
    public override GameCategory Category => GameCategory.Rayman;
    public override GameType Type => GameType.Demo;

    public override LocalizedString DisplayName => new ResourceLocString(nameof(Resources.Rayman3_Demo_20030108_Win32_Title));
